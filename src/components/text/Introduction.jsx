...
export default function Introduction() {
  return (
    <article className="introduction">
      ...
      <p>
        RuneScape has an in-game market called the Grand Exchange. Players can
        sell their goods they produced and players can buy items they need for
        quests, improving their skills or fashion. Players exchange a huge
        amount of cash each day via this market, but how do these prices get
        influenced? To find out, I made a visualization about my exploration to
        find the answers.
      </p>
    </article>
  )
